...
\centering
\subfigure[$k=2$, $c=1$]{
\includegraphics[width=\figwidth]{figures/asend3a.pdf}
\label{fig:stoch_n_effect1}
}
\subfigure[$k=4$, $c=10$]{
\includegraphics[width=\figwidth]{figures/asend3b.pdf}
...
\includegraphics[width=\figwidth]{figures/asend4a.pdf}
\label{fig:stoch_roc_pred}
}
\subfigure[Deterministic]{
\includegraphics[width=\figwidth]{figures/asend4b.pdf}
...
\centering
\subfigure[$m=5000$]{
\includegraphics[width=\figwidth]{figures/asend5a.pdf}
\label{fig:stoch_m_large}
}
\subfigure[$m=250$]{
\includegraphics[width=\figwidth]{figures/asend5b.pdf}
...
\centering
\subfigure[Stochastic]{
\includegraphics[width=\figwidth]{figures/asend6a.pdf}
\label{fig:stoch_theory_epsilon}
}
\subfigure[Deterministic]{
\includegraphics[width=\figwidth]{figures/asend6b.pdf}
