%\documentclass[peerreview,draftcls,onecolumn]{IEEEtran}
...
\newcommand{\twrc}{{\sf TW}_{\reals,\complex}}
\newcommand{\sx}{s_{x,i}}
\newcommand{\sy}{s_{y,i}}
\newcommand{\zx}{z_{x,i}}
\newcommand{\zy}{z_{y,i}}
...
\author{Nicholas~Asendorf,~\IEEEmembership{Member,~IEEE,}
        Raj~Rao~Nadakuditi,~\IEEEmembership{Member,~IEEE}% <-this % stops a space
...
of Electrical Engineering and Computer Science, University of Michigan, Ann Arbor, MI
 48019 USA e-mail: asendorf@umich.edu}% <-this % stops a space
\thanks{R.R. Nadakuditi is with the Department
of Electrical Engineering and Computer Science, University of Michigan, Ann Arbor, MI
 48019 USA e-mail: rajnrao@umich.edu}}% <-this % stops a space
...
\begin{IEEEkeywords}
Canonical correlation analysis, Detection algorithms, Random matrix theory
\end{IEEEkeywords}
...
\bibliographystyle{IEEEtran}
\bibliography{IEEEabrv,thesis_bib}
...
% simpler here.)
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figs/asendorf.jpg}}]{Nicholas
  Asendorf}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figs/raj.jpg}}]{Raj
    Rao Nadakuditi}
